...
function footer() {
	...
	document.write(
		...
		'<a href="https://www.paypal.com/donate/?hosted_button_id=LDZPJ2ZXC9K8A" class="footer-dj-links" target="_blank" title="PayPal"><img src="/gfx/donate1.png"></a> '+
		'<br><br>'+
...
function mailme() {
	var m = ['t','i','o','i','c','.','l','o','o','a','s','t','r','h','t','o','n','m','m',':','c','@','p'];
	var c = [17,9,1,6,14,15,19,22,8,10,11,21,0,13,12,2,16,3,4,5,20,7,18];
	var e = '';
